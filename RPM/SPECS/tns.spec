...
Summary: TomlNameService is Linux User,Group Name Service
Name: tns
Group: TomlNameService
URL: https://github.com/pyama86/TomlNameService
Version: 0.1
Release: 1
License: MIT
Source0:   %{name}.initd
...
%description
Api of TomlNameService generate json from toml config file
